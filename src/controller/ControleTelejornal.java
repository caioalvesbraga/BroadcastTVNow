...
public class ControleTelejornal {
	public boolean cadastrarTelejornal(String apresentadores, String canal, String classificacao, String descricao, 
		...
		{
			Telejornal novoJornal = new Telejornal(apresentadores, canal, classificacao, descricao,
