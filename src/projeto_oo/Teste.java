...
public class Teste {
	...
	static void testaCanal() {
		...
		System.out.println("Get de Nome Emissora: " + cnn.getNomeEmissora() + "\nGet de Numero Emissora: "
				+ cnn.getNumEmissora() + "\nGet de Tipo Emissora: " + cnn.getTipoEmissora() + "\n");
	}
	...
	static void testaFavoritos() {
		...
		novaConta.setProgramaFavorito("12", "2h e 30min", "Herois", "21h", "Batman é um super-heroi", "Batman");
		System.out.print(novaConta.getProgramaFavorito());
		System.out.println("\n*Após os métodos sets de Programa Favorito*\n");
		novaConta.setProgramaFavorito("18", "2h e 42min", "Herois", "23h", "Deadpool é um anti-heroi", "Deadpool");
	...
	static void testaPrograma() {
		...
		Programa caldeirao = new Programa("AL", "1h e 30min", "Auditório", "14h",
				"Caldeirão é um programa de auditório\napresentado por Marcos Mion", "Caldeirao");
		...
		System.out.println("\nGet de Classificação Indicativa: " + caldeirao.getClassificacaoIndicativa()
